...
a la tabla PropiedadRaw de la base de datos (versión automática sin confirmación).
"""
import os
import sys
import pandas as pd
...
# Configurar Django
# Estamos en el directorio webapp, así que el módulo settings está disponible
...
if __name__ == '__main__':
    print("=== IMPORTADOR DE PROPIEDADES RAW (AUTOMÁTICO) ===")
    print("Importando datos desde propiedadesraw_para_azure.xlsx a la tabla PropiedadRaw...")
