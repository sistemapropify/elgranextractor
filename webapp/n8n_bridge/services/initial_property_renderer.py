...
TEMPLATES = {
    "hotel": "¡Gracias por escribirnos! 😊\nEste hotel está ubicado en {location}, cuenta con {features} y tiene un precio de {price}.\n\nEn este momento estamos fuera del horario de atención. Apenas uno de nuestros asesores esté disponible, continuará la conversación contigo.\n\nMientras tanto, ¿te interesa operarlo directamente o evaluarlo como inversión? Así podemos orientarte mejor cuando continúe la atención.",
