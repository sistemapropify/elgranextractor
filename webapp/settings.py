...
MOBILE_APP_VERSION_NAME = env('MOBILE_APP_VERSION_NAME', default='')
...
PROPIFY_AUTH_REFRESH_URL = env('PROPIFY_AUTH_REFRESH_URL', default='https://api.propify.pe/api/auth/token/refresh/')
