#!/usr/bin/env python
"""
Script simple para verificar la base de datos 'propifai' sin emojis.
"""
import os
import sys
import django
...
def main():
    print("=== Verificando conexion a base de datos 'propifai' ===")
    
    # Verificar si existe la conexión
    if 'propifai' not in connections:
        print("ERROR: No hay conexion 'propifai' en connections")
        return
    ...
    try:
        ...
        print("OK - Conexion 'propifai' establecida")
        ...
        with conn.cursor() as cursor:
            ...
            if result:
                ...
                for col_name, data_type in columns[:10]:  # Mostrar primeras 10
