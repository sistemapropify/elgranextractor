...
def reconfigurar_coleccion():
    ...
    print("=== RECONFIGURACION DE COLECCION EXISTENTE ===")
    ...
    try:
        ...
        # Basado en el analisis de esquema que hicimos anteriormente
        ...
        # Actualizar field_definitions si es necesario
        if collection.field_definitions:
            print(f"  - Field definitions: {len(collection.field_definitions)} campos definidos")
        ...
        print(f"❌ Coleccion 'propiedades_propify' no encontrada")
        return None
    ...
    try:
        ...
        if doc_count_after > 0:
            ...
            for i, doc in enumerate(documentos):
                ...
                print(f"    Embedding: {'✅' if doc.embedding else '❌'}")
        else:
            print(f"\n⚠️  La sincronizacion no importo documentos.")
    ...
    try:
        ...
        with connections['propifai'].cursor() as cursor:
            ...
            if row_count > 0:
                ...
                print(f"⚠️  La tabla 'properties' esta vacia")
...
if __name__ == "__main__":
    ...
    if row_count == 0:
        print(f"\n❌ No se puede sincronizar: la tabla 'properties' esta vacia.")
    ...
    if collection:
        ...
        if success and doc_count > 0:
            ...
            print(f"\n" + "=" * 80)
            print(f"⚠️  PROCESO COMPLETADO CON ADVERTENCIAS")
